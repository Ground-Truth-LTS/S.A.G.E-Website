        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-6 md:mb-0 md:w-1/4">
            ...
            <nav>
              <ul className="space-y-2">
                <li><a href={import.meta.env.BASE_URL} className="text-gray-300 hover:text-green-400">Home</a></li>
                <li><a href={import.meta.env.BASE_URL+"/about"} className="text-gray-300 hover:text-green-400">Team</a></li>
                <li><a href={import.meta.env.BASE_URL+"/mobileapp"} className="text-gray-300 hover:text-green-400">Mobile Application</a></li>
                <li><a href={import.meta.env.BASE_URL+"/device"} className="text-gray-300 hover:text-green-400">Device</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="md:w-1/4">
            ...
            <div className="flex space-x-4 mt-4">
              <a href={import.meta.env.BASE_URL+"https://github.com/emmagonz22/S.A.G.E"} className="text-gray-300 hover:text-green-400" aria-label="GitHub">
